                            ...
                            >
                                <div className="relative aspect-square bg-gray-100 dark:bg-gray-800 overflow-hidden">
                                    ...
                                    {hoveredProduct === product._id && (
                                        <div className="hidden sm:flex absolute inset-0 bg-black/40 items-end justify-center pb-4 pointer-events-none">
                                            <button
                                                onClick={(e) => {
                                                    e.stopPropagation();
                                                    openQuickView(product);
                                                }}
                                                className="pointer-events-auto flex items-center gap-1.5 px-3 py-1.5 bg-white dark:bg-gray-900 hover:bg-emerald-600 hover:text-white text-gray-800 dark:text-gray-100 text-xs font-medium rounded-full transition-colors"
                                            >
                                    ...
                                    <QuickAddButton product={product} className="absolute bottom-2 right-2 w-8 h-8" />
                                </div>

...
function Navbar() {
    ...
    }, [fetchCategories, fetchWishlistCount]);
    ...
    return (
        <>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex items-center h-16 sm:h-20">
                        ...
                        <div className="flex-1 flex items-center justify-start min-w-0">
                            ...
                            <div className="hidden md:flex space-x-5 lg:space-x-7 items-center">
                                ...
                                <div className="relative group">
                                    ...
                                    <div className="absolute left-0 mt-0 w-52 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50 overflow-hidden">
                                        ...
                                        <div className="py-2">
                                            {categories.length > 0 ? (
                                                ...
                                                <span className="block px-4 py-2 text-sm text-gray-500 dark:text-gray-400">No categories found</span>
                                            )}
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="flex-1 flex items-center justify-end space-x-1.5 sm:space-x-3 min-w-0">
                            {/* Mobile: search opens the drawer (which has its own SearchBox).
                                Desktop: search opens an inline popover right here. */}
                                ...
                                {desktopSearchOpen && (
                                    <div className="absolute right-0 top-full mt-2 w-96">
                                        <SearchBox
                                            ...
                                            inputClassName="w-full pl-11 pr-4 py-3 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 text-sm shadow-xl"
                                        />
                                    </div>
                                )}
                            </div>
                            <button
                                onClick={() => setMobileMenuOpen(true)}
                                className="md:hidden p-2 opacity-90 hover:opacity-100 hover:bg-white/10 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-white/40"
                                aria-label="Search"
                            >
                                <FiSearch className="w-5 h-5 sm:w-6 sm:h-6" />
                            </button>
                            ...
                            <div className="relative group hidden md:block">
                                ...
                                <div className="absolute right-0 mt-0 w-60 bg-white dark:bg-gray-900 border border-gray-100 dark:border-gray-800 rounded-xl shadow-xl opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 z-50 overflow-hidden">
                                    <div className="h-1" style={{ background: "linear-gradient(to right, var(--theme-primary), var(--theme-accent))" }} />
                                    {customer ? (
                                        <div className="py-1">
                                            ...
                                            <Link href="/account" className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50 dark:hover:bg-gray-800 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors">
                                                <FiUser className="w-4 h-4" /> My Account
                                            </Link>
                                            <Link href="/account/orders" className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50 dark:hover:bg-gray-800 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors">
                                                <FiPackage className="w-4 h-4" /> My Orders
                                            </Link>
                                            <Link href="/account/addresses" className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50 dark:hover:bg-gray-800 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors">
                                                <FiMapPin className="w-4 h-4" /> Addresses
                                            </Link>
                                            <button
                                                onClick={() => { logout(); router.push("/"); }}
                                                className="w-full text-left flex items-center gap-2.5 px-4 py-2.5 text-sm text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 transition-colors border-t border-gray-50 dark:border-gray-800"
                                            >
                                        ...
                                        <div className="py-1">
                                            <Link href="/account/login" className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50 dark:hover:bg-gray-800 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors">
                                                <FiUser className="w-4 h-4" /> Sign in
                                            </Link>
                                            <Link href="/account/register" className="flex items-center gap-2.5 px-4 py-2.5 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50 dark:hover:bg-gray-800 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors">
                            ...
                            <button onClick={openDrawer} className="relative" aria-label="Cart">
                                <span
                                    className="flex p-2 opacity-90 hover:opacity-100 hover:bg-white/10 rounded-full transition-all focus:outline-none focus:ring-2 focus:ring-white/40"
                                >
            ...
            <aside
                className={`fixed top-0 left-0 h-full w-80 max-w-[85vw] bg-white dark:bg-gray-950 z-[70] md:hidden transform transition-transform duration-300 ease-[cubic-bezier(0.2,0.8,0.2,1)] shadow-2xl ${
            ...
            >
                <div className="flex flex-col h-full">
                    ...
                    {/* Search bar */}
                    <div className="p-4 border-b border-gray-100 dark:border-gray-800 bg-gray-50/60 dark:bg-gray-900">
                        <SearchBox
                            onNavigate={closeMobileMenu}
                            inputClassName="w-full pl-11 pr-4 py-3 bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 border border-gray-200 dark:border-gray-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 text-sm shadow-sm"
                        />
                    </div>
                    ...
                    <div className="flex-1 overflow-y-auto hide-scrollbar">
                            ...
                            {customer ? (
                                <div className="rounded-xl ring-1 ring-emerald-100 dark:ring-emerald-900/50 overflow-hidden">
                                    ...
                                    <div className="bg-white dark:bg-gray-950">
                                        <Link href="/account" onClick={closeMobileMenu} className="flex items-center gap-2.5 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50/60 dark:hover:bg-gray-900 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors border-t border-gray-50 dark:border-gray-800">
                                            <FiUser className="w-4 h-4 text-emerald-600" /> My Account
                                        </Link>
                                        <Link href="/account/orders" onClick={closeMobileMenu} className="flex items-center gap-2.5 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50/60 dark:hover:bg-gray-900 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors border-t border-gray-50 dark:border-gray-800">
                                            <FiPackage className="w-4 h-4 text-emerald-600" /> My Orders
                                        </Link>
                                        <Link href="/account/addresses" onClick={closeMobileMenu} className="flex items-center gap-2.5 px-4 py-3 text-sm text-gray-700 dark:text-gray-200 hover:bg-emerald-50/60 dark:hover:bg-gray-900 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors border-t border-gray-50 dark:border-gray-800">
                                            <FiMapPin className="w-4 h-4 text-emerald-600" /> Addresses
                                        </Link>
                                        <button
                                            onClick={() => { logout(); closeMobileMenu(); router.push("/"); }}
                                            className="w-full text-left flex items-center gap-2.5 px-4 py-3 text-sm text-rose-600 dark:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/40 transition-colors border-t border-gray-50 dark:border-gray-800"
                                        >
                                            <FiLogOut className="w-4 h-4" /> Sign out
                                        </button>
                                    </div>
                        ...
                        <div className="px-4 pt-4">
                            ...
                            >
                                ...
                                <svg
                                    className={`w-5 h-5 text-emerald-700 dark:text-emerald-400 transition-transform duration-200 ${mobileCategoriesOpen ? "rotate-180" : ""}`}
                                    fill="none"
                                    stroke="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            >
                                <div className="py-1">
                                    {categories.length > 0 ? (
                                        ...
                                        <div className="px-3 py-2 text-sm text-gray-500 dark:text-gray-400">No categories found</div>
                                    )}
                                </div>
                            </div>
                        </div>
                        ...
                        <nav className="mt-4 px-4">
                            <p className="text-[11px] uppercase tracking-[0.18em] text-gray-400 dark:text-gray-500 font-semibold mb-2">
                                More
                            </p>
                            <div className="bg-white dark:bg-gray-900 rounded-xl ring-1 ring-gray-100 dark:ring-gray-800 overflow-hidden">
                                {mobileSecondaryLinks.map(({ href, label, Icon }, i) => (
                                    <Link
                                        key={href}
                                        href={href}
                                        onClick={closeMobileMenu}
                                        className={`flex items-center gap-3 px-4 py-3 text-gray-700 dark:text-gray-200 hover:bg-emerald-50/60 dark:hover:bg-gray-800 hover:text-emerald-700 dark:hover:text-emerald-400 transition-colors ${i !== 0 ? "border-t border-gray-50 dark:border-gray-800" : ""}`}
                                    >

            ...
            <div className="max-w-7xl mx-auto grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
                {ITEMS.map(({ icon: Icon, title, sub }, i) => (
                    <Reveal key={title} delay={i * 60}>
                        <div className="h-full flex items-center gap-2.5 sm:gap-3 rounded-2xl border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 px-3 sm:px-4 py-3.5 sm:py-4 shadow-sm">
                            <span
                            ...
                            <span className="min-w-0">
                                <span className="block text-[12px] sm:text-sm font-semibold text-gray-900 dark:text-gray-50 leading-snug">
                                    {title}
                                </span>
                                <span className="block text-[10.5px] sm:text-xs text-gray-500 dark:text-gray-400 leading-snug">{sub}</span>
                            </span>
                        </div>
                    </Reveal>
                ))}
